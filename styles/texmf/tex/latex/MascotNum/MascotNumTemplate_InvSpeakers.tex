...
% 
% % % % % % % % % % % % % % % % % % % % % % % % % % % %
\documentclass{MascotNumAbstractInvSpeakers}  
...
% J. Smith
 \author{An Invited Speaker}
% Short form of the author names (will appear in the odd/even pages of the abstracts)
 \shortauthor{A. Invited Speaker} 
% Corresponding author
 \correspondingauthor{A. PhDStudent}
% Corresponding author address
 \firstauthoraddress{\emph{Chair of Risk, Safety and Uncertainty Quantification}, ETH Z\"urich,  
 Wolfgang-Pauli-strasse 15, CH-8093 Z\"urich, Switzerland}
% Institution 
...
% Contact mail
 \contactmail{myname@my.institution.com} 
